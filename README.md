...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| [![Arch_AWS-CloudFormation_32](./images/Arch_AWS-CloudFormation_32.png)](https://us-west-2.console.aws.amazon.com/cloudformation/home?region=us-west-2#/stacks/create/review?templateURL=https://gl-public-templates.s3.amazonaws.com/cfn/v1.4.2-alpha7/easybutton-amazon-linux-2-docker-simple-warm-ha.cf.yml&stackName=linux-docker-warm-ha) | Amazon Linux 2 Docker Simple Warm HA with scheduling.        | One docker executor instance that will respawn if it terminates, no autoscaling, no spot instances, ability to schedule when it will run. |
